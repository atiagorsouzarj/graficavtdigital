    ...
    <>
      <div className="fixed inset-0 bg-slate-900/70 backdrop-blur-xs z-50 flex items-center justify-center p-3 sm:p-6 overflow-y-auto">
        <div className="bg-white rounded-2xl max-w-3xl w-full p-6 shadow-2xl border border-slate-200 relative my-auto animate-in zoom-in-95 duration-150 space-y-4">
          ...
          {/* Printable A4 Sheet Layout matching Screenshot 1 */}
          <div className="bg-white p-6 sm:p-8 border border-slate-200 rounded-2xl space-y-6 text-xs text-slate-800 select-text shadow-sm printable-area">
