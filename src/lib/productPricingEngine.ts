export interface ProductComponentItem {
  id: string;
  category: "insumo" | "maquina" | "mao_obra" | "embalagem";
  sku: string;
  name: string;
  unit: string;
...
export interface QuantityTierDiscount {
  minQty: number; // e.g. 100, 500, 1000, 5000
  discountPercent: number; // e.g. 0%, 15%, 25%, 35%
}
...
export const YIELD_MATRIX_PRESETS = [
  { label: "Cartão de Visita (9x5 cm)", yieldPerSheet: 24, factor: 0.0416 },
  { label: "Etiqueta Redonda (5x5 cm)", yieldPerSheet: 40, factor: 0.0250 },
  { label: "Etiqueta Redonda (4x4 cm)", yieldPerSheet: 54, factor: 0.0185 },
  { label: "Etiqueta Redonda (3x3 cm)", yieldPerSheet: 108, factor: 0.0092 },
  { label: "Panfleto / Folder A5 (15x21 cm)", yieldPerSheet: 4, factor: 0.2500 },
  { label: "Caixa Cone / Pirâmide (15x10 cm aberta)", yieldPerSheet: 1, factor: 1.0000 },
];
    ...
    components: [
      {
        id: "c1",
        category: "insumo",
        sku: "INS-PAP-COU300A3",
        name: "Papel Couché 300g A3 (4.16 FLS para 100un)",
        unit: "FLS",
    ...
    components: [
      {
        id: "e1",
        category: "insumo",
        sku: "INS-ADE-COUCHEA3",
        name: "Papel Adesivo Couché A3 (0.025 FLS por etiqueta)",
        unit: "FLS",
    ...
    components: [
      {
        id: "x1",
        category: "insumo",
        sku: "INS-PAP-OFF180A3",
        name: "Papel Offset 180g A3 (1.0 FLS por caixa)",
        unit: "FLS",
        quantityConsumed: 1.0000,
        unitCost: 0.50,
      },
      ...
      },
      {
        ...
        category: "insumo",
        sku: "INS-FITA-BANANA",
        name: "Fita Banana para Aplique 3D (0.1m)",
        unit: "M",
        quantityConsumed: 0.1000,
        unitCost: 0.80,
      },
    ],
  },
